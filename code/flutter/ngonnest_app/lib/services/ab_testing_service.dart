...
class ABTestingService {
  ...
  String getExperimentVariant(String experimentKey) {
    try {
      return _remoteConfig.getString('${experimentKey}_variant') ??
          _variantControl;
    } catch (e) {
      log(
        'Error getting experiment variant for $experimentKey: $e',
  ...
  String get homepageLayoutVariant =>
      getExperimentVariant(_homepageLayoutExperiment);

  // Get the CTA button color variant
  String get ctaButtonColorVariant =>
      getExperimentVariant(_ctaButtonColorExperiment);
  ...
  Map<String, String> getAllActiveExperiments() {
    return {
      _homepageLayoutExperiment: getExperimentVariant(
        _homepageLayoutExperiment,
      ),
      _ctaButtonColorExperiment: getExperimentVariant(
        _ctaButtonColorExperiment,
      ),
    };
  }
  ...
  bool getFeatureWithExperiment(
    ...
    try {
      ...
      log(
        'Error getting feature with experiment: $e',
        name: 'ABTestingService',
      );
