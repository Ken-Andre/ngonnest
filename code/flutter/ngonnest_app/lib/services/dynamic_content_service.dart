...
class DynamicContentService {
  ...
  static const String _baseContentUrl =
      'https://storage.googleapis.com/your-bucket-name/ngonnest/content';
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      log(
        'Error initializing DynamicContentService: $e',
        name: 'DynamicContentService',
      );
    }
  }
  ...
  Future<String?> _getLocalContentPath(String contentKey) async {
    try {
      ...
      log(
        'Error getting local content path: $e',
        name: 'DynamicContentService',
      );
      return null;
    }
  ...
  Future<File?> getCachedImage(String imageName, {String? variant}) async {
    ...
    final fileName =
        '${path.basenameWithoutExtension(imageName)}_${variant ?? 'default'}';
