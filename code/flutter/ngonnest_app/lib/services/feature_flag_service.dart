...
class FeatureFlagService {
  ...
  bool isFeatureEnabled(String featureKey) {
    try {
      ...
      log(
        'Error checking feature flag $featureKey: $e',
  ...
  bool get isAdvancedAnalyticsEnabled =>
      isFeatureEnabled(_advancedAnalyticsKey);
  ...
  Future<void> trackFeatureUsage(
    ...
    try {
      ...
      await _analytics.logEvent(name: 'feature_usage', parameters: eventParams);
    } catch (e) {
  ...
  bool isAppVersionCompatible(String currentVersion) {
    try {
      ...
      log(
        'Error checking app version compatibility: $e',
        name: 'FeatureFlagService',
      );
